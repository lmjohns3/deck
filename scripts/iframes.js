...
(function() {
  var changeSlide, disableIframe, enableIframe, _base;
  ...
  changeSlide = function(e, from, to) {
    ...
    slides.$iframeIndex[to].forEach(function(iframe) {
      return setTimeout((function() {
        return enableIframe(iframe);
      }), slides.transition / 2);
    });
    return $('iframe').not(slides.$iframeIndex[to]).each(function() {
      var iframe;
      iframe = this;
      return setTimeout((function() {
  ...
  $(function() {
    $('.slide').each(function(i) {
      ...
      return [i - 1, i, i + 1].forEach(function(i) {
        var _base1;
        (_base1 = slides.$iframeIndex)[i] || (_base1[i] = []);
        return $iframes.each(function() {
          return slides.$iframeIndex[i].push(this);
        });
      });
    });
